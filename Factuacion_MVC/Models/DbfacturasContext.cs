...
public partial class DbfacturasContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        //=> optionsBuilder.UseSqlServer("server=DESKTOP-DRDOU36; database=[DBFACTURAS]; integrated security=true; Encrypt=False;")
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__TBLCATEG__A3C02A10060CFACC");
        ...
        {
            entity.HasKey(e => e.IdCliente).HasName("PK__TBLCLIEN__D5946642626B10E7");
        ...
        {
            entity.HasKey(e => e.IdDetalle).HasName("PK__TBLDETAL__E43646A5252874AA");
        ...
        {
            entity.HasKey(e => e.IdFactura).HasName("PK__TBLFACTU__50E7BAF1E622AD33");
